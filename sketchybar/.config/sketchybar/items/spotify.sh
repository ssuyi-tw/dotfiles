...
spotify_anchor=(
  ...
  icon=
  icon.font="$NERD_FONT:Regular:17.0"
  label.font="$FONT:Regular:13.0"
  label.drawing=on
  drawing=off
  y_offset=0
  # Poll even while drawing=off — music_change doesn't fire on plain app launch,
  # so we need a heartbeat to notice Spotify starting and un-hide the plugin.
  updates=on
  update_freq=3
)
...
sketchybar --add event music_change $SPOTIFY_EVENT               \
